...
const service = SERVICES.find((s) => s.slug === 'electrical-repairs')!;
const path = '/electrical-repair-sevierville';
...
export default function ElectricalRepairSeviervillePage() {
